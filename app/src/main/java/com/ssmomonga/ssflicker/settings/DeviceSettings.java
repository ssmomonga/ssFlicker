...
public class DeviceSettings {
	...
	public static String getBackupDir(Context context) {
		String externalDirStr = Environment.getExternalStorageDirectory() + "/" +
				context.getApplicationInfo().loadLabel(context.getPackageManager()) + "/";
		File externalDir = new File(externalDirStr);
		return (externalDir.exists() || externalDir.mkdir()) ? externalDirStr : null;
	}
