...
public class _AppShortcut {
     ...
     * @param shortcutInfo
     */
    public _AppShortcut(Context context, ShortcutInfo shortcutInfo) {
    ...
    public Drawable getRawIcon() {
        return launcherApps.getShortcutBadgedIconDrawable(
                shortcutInfo,
                (int) DeviceSettings.getDensity(context));
    }
